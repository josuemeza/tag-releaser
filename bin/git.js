...
exports.pushTag = exports.currentCommit = void 0;
var utils_1 = require("./utils");
var currentCommit = function () { return __awaiter(void 0, void 0, void 0, function () {
    var _a, stdout, stderr, _b, key, line, message;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, utils_1.exec("git log --oneline | head -n 1")];
            case 1:
                _a = _c.sent(), stdout = _a.stdout, stderr = _a.stderr;
                if (stderr)
                    throw new Error(stderr);
                _b = stdout.split(" "), key = _b[0], line = _b.slice(1);
                message = line.join(" ").trim();
                return [2 /*return*/, { key: key, message: message }];
        }
    });
}); };
